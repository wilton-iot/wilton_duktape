...
public:
    ...
    void duk_trans_socket_init(transport_protocol_socket&, unsigned long debug_port) {
    ...
    void duk_trans_socket_finish(transport_protocol_socket&) {
        if (client_sock >= 0) {
    ...
    duk_size_t duk_trans_socket_read_cb(transport_protocol_socket&, void *udata, char *buffer, duk_size_t length) {
        ssize_t ret;
    ...
    duk_size_t duk_trans_socket_write_cb(transport_protocol_socket&, void *udata, const char *buffer, duk_size_t length) {
        ssize_t ret;
    ...
    duk_size_t duk_trans_socket_peek_cb(transport_protocol_socket&, void *udata) {
    #if defined(USE_SELECT)
        struct timeval tm;
        fd_set rfds;
        int select_rc;
    ...
    void duk_trans_socket_read_flush_cb(transport_protocol_socket&, void *udata) {
        (void) udata;  /* not needed by the example */
    ...
    void duk_trans_socket_write_flush_cb(transport_protocol_socket&, void *udata) {
        (void) udata;  /* not needed by the example */
...
PIMPL_FORWARD_METHOD(transport_protocol_socket, void, duk_trans_socket_init, (unsigned long), (), support::exception);
PIMPL_FORWARD_METHOD(transport_protocol_socket, void, duk_trans_socket_finish, (), (), support::exception);
PIMPL_FORWARD_METHOD(transport_protocol_socket, void, duk_trans_socket_waitconn, (), (), support::exception);
PIMPL_FORWARD_METHOD(transport_protocol_socket, duk_size_t, duk_trans_socket_read_cb, (void*)(char*)(duk_size_t), (), support::exception);
PIMPL_FORWARD_METHOD(transport_protocol_socket, duk_size_t, duk_trans_socket_write_cb, (void*) (const char*) (duk_size_t), (), support::exception);
PIMPL_FORWARD_METHOD(transport_protocol_socket, duk_size_t, duk_trans_socket_peek_cb, (void*), (), support::exception);
PIMPL_FORWARD_METHOD(transport_protocol_socket, void, duk_trans_socket_read_flush_cb, (void*), (), support::exception);
PIMPL_FORWARD_METHOD(transport_protocol_socket, void, duk_trans_socket_write_flush_cb, (void*), (), support::exception);
